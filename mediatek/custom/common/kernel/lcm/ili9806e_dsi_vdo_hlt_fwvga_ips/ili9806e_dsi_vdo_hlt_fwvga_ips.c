...
#define MIN_VOLTAGE (201)	//#define MIN_VOLTAGE (200)	// +++++rgk bug_id:no modify by yangjuwei 20140219
...
#define LCM_ID_ILI9806	0x9806    // +++++rgk bug_id:no modify by yangjuwei 20140219
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0x30,1,{0x01}},	//Resolution setting 480 X 800 
	{0x31,1,{0x02}},        //Inversion setting 2-dot 
	{0x40,1,{0x14}},	//BT  
	{0x41,1,{0x33}},	//Default 
	{0x42,1,{0x03}},	//    
	{0x43,1,{0x09}},	//Default 
...
static unsigned int lcm_esd_recover(void)
{
	...
	#ifndef BUILD_LK
	printk("lcm_esd_recover  ili9806e_dsi_vdo_hlt_fwvga_ips \n");
	#endif
	return TRUE;
}
...
LCM_DRIVER ili9806e_dsi_vdo_hlt_fwvga_ips_lcm_drv = 
{
    .name			= "ili9806e_dsi_vdo_hlt_fwvga_ips",
