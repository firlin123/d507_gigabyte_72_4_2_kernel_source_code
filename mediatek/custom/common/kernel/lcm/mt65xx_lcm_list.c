...
extern LCM_DRIVER otm8018b_dsi_vdo_trust_fwvga_ips_lcm_drv;	  // zhoulidong add
...
extern LCM_DRIVER ili9806c_dsi_vdo_djn_d207_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_qj_d207_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_txd_d207_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_txd_ips_lcm_drv;   // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_azet_ips_j210_lcm_drv; //add by yangjuwei
extern LCM_DRIVER ili9806e_dsi_vdo_txd_ips_lcm_drv;   // zhoulidong add
extern LCM_DRIVER hx8379a_dsi_vdo_azet_ips_lcm_drv; //add by yangjuwei
extern LCM_DRIVER hx8357c_rgb_hvga_djn_lcm_drv;   // zhoulidong add
extern LCM_DRIVER ili9806e_dsi_vdo_dijin_fwvga_d507_lcm_drv; //add by yangjuwei
extern LCM_DRIVER ili9488_rgb_hvga_djn_lcm_drv; //add by yangjuwei
extern LCM_DRIVER ili9806e_dsi_vdo_azet_fwvga_ips_lcm_drv; //add by yangjuwei
extern LCM_DRIVER otm8018b_dsi_vdo_trust_ips_lcm_drv;//add by yangjuwei
extern LCM_DRIVER ili9806e_dsi_vdo_hlt_fwvga_ips_lcm_drv; //++++rgk bug_id:no add by yangjuwei 20140220

LCM_DRIVER* lcm_driver_list[] = 
{
#if defined(ILI9488_RGB_HVGA_DJN)
	&ili9488_rgb_hvga_djn_lcm_drv,
#endif

#if defined(ILI9806E_DSI_VDO_DIJIN_FWVGA_D507)
	&ili9806e_dsi_vdo_dijin_fwvga_d507_lcm_drv,
#endif
...
#if defined(OTM8018B_DSI_VDO_TRUST_FWVGA_IPS)	
	&otm8018b_dsi_vdo_trust_fwvga_ips_lcm_drv, 
#endif
...
#endif
//add by yangjuwei
#if defined(ILI9806E_DSI_VDO_TXD_IPS)	
	&ili9806e_dsi_vdo_txd_ips_lcm_drv, 
#endif

#if defined(ILI9806C_DSI_VDO_DJN_D207)	
	&ili9806c_dsi_vdo_djn_d207_lcm_drv, 
#endif

#if defined(ILI9806C_DSI_VDO_TXD_D207)	
	&ili9806c_dsi_vdo_txd_d207_lcm_drv, 
#endif

#if defined(ILI9806C_DSI_VDO_QJ_D207)	
	&ili9806c_dsi_vdo_qj_d207_lcm_drv, 
#endif
//add by yangjuwei
#if defined(ILI9806C_DSI_VDO_AZET_IPS_J210)	
	&ili9806c_dsi_vdo_azet_ips_j210_lcm_drv, 
#endif
//add by yangjuwei
...
#if defined(HX8357C_RGB_HVGA_DJN)
	&hx8357c_rgb_hvga_djn_lcm_drv,
#endif
//add by yangjuwei
#if defined(ILI9806E_DSI_VDO_AZET_FWVGA_IPS)
	&ili9806e_dsi_vdo_azet_fwvga_ips_lcm_drv, 
#endif

//add by yangjuwei
#if defined(OTM8018B_DSI_VDO_TRUST_IPS)
	&otm8018b_dsi_vdo_trust_ips_lcm_drv,
#endif

//++++rgk bug-id:no add by yangjuwei 20140220 start
#if defined(ILI9806E_DSI_VDO_HLT_FWVGA_IPS)
	&ili9806e_dsi_vdo_hlt_fwvga_ips_lcm_drv, 
#endif
//++++rgk bug-id:no add by yangjuwei 20140220 end
