...
---------------------------------------------------------------------------------
AZET    |   ILI9806E	|	0.6V	|MS-A40213N00QO-A       |		|
---------------------------------------------------------------------------------	
...
#define LCM_ID_ILI9806						0x9806  //D3
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0x40,1,{0x17}},                // BT  +2.5/-3 pump for DDVDH-L

	{0x41,1,{0x44}},                // DVDDH DVDDL clamp  5.39  -5.32
	 
	{0x42,1,{0x11}},   //02              // VGH/VGL -1.9 1.63

	{0x43,1,{0x06}},                 // VGHL 13.58

	{0x44,1,{0x09}},                 // VGL -11.89
	...
	{0xA1,1,{0x10}},  // Gamma 4 /251

	{0xA2,1,{0x17}},  // Gamma 8 /247

	{0xA3,1,{0x0F}},  // Gamma 16	/239

	{0xA4,1,{0x05}},  // Gamma 24 /231

	{0xA5,1,{0x0C}},  // Gamma 52 / 203
	...
	{0xAA,1,{0x10}},  // Gamma 203 / 52

	{0xAB,1,{0x08}},  // Gamma 231 / 24

	{0xAC,1,{0x0F}},  // Gamma 239 / 16

	{0xAD,1,{0x18}},  // Gamma 247 / 8

	{0xAE,1,{0x11}},  // Gamma 251 / 4
...
LCM_DRIVER ili9806e_dsi_vdo_azet_fwvga_ips_lcm_drv = 
{
    .name			= "ili9806e_dsi_vdo_azet_fwvga_ips",
