...
# add for special customer by anxiang.xiao
#MTK_PROJECT_CUSTOMER = PROJECT_CUSTOMER_D208
#pengjinlong modify start
RGK_D208_BATTERY = yes
#pengjinlong modify end
# support build CTS or not
BUILD_CTS=no
#BUG_ID:DELB-1256 add by zhaoguangyou 2013.08.05 [start]
RGK_BOOT_SHUT_TONE = yes
#BUG_ID:DELB-1256 add by zhaoguangyou 2013.08.05 [end]
...
# already release
CUSTOM_BUILD_VERNO=Rey_R3_V1.28.14@GSmart
#add by jinhaijian for internal bld number
CUSTOM_INTERNAL_BUILD_VERNO = D507_GIGABYTE_G1A_V3.10.0_S0710
...
CUSTOM_HAL_IMGSENSOR=ov5645_mipi_yuv s5k5eayx_yuv hi704_yuv sp0a19_yuv
...
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=s5k5eayx_yuv
...
CUSTOM_KERNEL_IMGSENSOR=ov5645_mipi_yuv s5k5eayx_yuv hi704_yuv sp0a19_yuv
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR=s5k5eayx_yuv
...
# change tp code order to make sure tp min check during boot by anxiang.xiao 2014-01-20
#CUSTOM_KERNEL_TOUCHPANEL=GT9XX_2 msg2133 
CUSTOM_KERNEL_TOUCHPANEL=msg2133 GT9XX_2
...
CUSTOM_LK_LCM=ili9806e_dsi_vdo_dijin_fwvga_d507 otm8018b_dsi_vdo_trust_fwvga_ips ili9806e_dsi_vdo_azet_fwvga_ips ili9806e_dsi_vdo_hlt_fwvga_ips
...
# modify BUG_ID:DELB-1246 weipengfei 20130802 (stary)
# DEFAULT_INPUT_METHOD=com.sohu.inputmethod.sogou.SogouIME
DEFAULT_INPUT_METHOD=com.cootek.smartinputv5.oem/com.cootek.smartinput5.TouchPalIME
# modify BUG_ID:DELB-1246 weipengfei 20130802 (end)
...
#DELB-1478 modify by zhaoguangyou 2013.08.22 [start]
#MTK_DATAUSAGE_SUPPORT=no
MTK_DATAUSAGE_SUPPORT=yes
#DELB-1478 modify by zhaoguangyou 2013.08.22 [end]
...
#modify by lixiaobin BUG_ID:DELB-1470 start
#MTK_MULTISIM_RINGTONE_SUPPORT=no
MTK_MULTISIM_RINGTONE_SUPPORT=yes
#modify by lixiaobin BUG_ID:DELB-1470 end
...
# libvorbisdec_mtk
MTK_SWIP_VORBIS=yes
#DELB-1676 if no,delete mtk SystemUpdate
...
# yes/no
#modify zengchuiguo 2013.09.29 BUG_ID:DELB-2272 (start)
MTK_WFD_SUPPORT=no
#MTK_WFD_SUPPORT=yes
#modify zengchuiguo 2013.09.29 BUG_ID:DELB-2272 (end)
...
#add zhaoguangyou 2013.06.20 BUG_ID:DELB-226 (start)
#OPTR_SPEC_SEG_DEF=OP02_SPEC0200_SEGA
OPTR_SPEC_SEG_DEF=NONE
#add zhaoguangyou 2013.06.20 BUG_ID:DELB-226 (end)
...
CUSTOM_MODEM=d507_gsm4_w1258_compatible_hspa_gemini
...
#DELB-1204 add by zhaoguangyou 2013.08.01[start]
#BOOT_LOGO=cu_wvga
BOOT_LOGO=d507_gigabyte
#DELB-1204 add by zhaoguangyou 2013.08.01[end]
# To choose kernel LCM driver name
CUSTOM_KERNEL_LCM=ili9806e_dsi_vdo_dijin_fwvga_d507 otm8018b_dsi_vdo_trust_fwvga_ips ili9806e_dsi_vdo_azet_fwvga_ips ili9806e_dsi_vdo_hlt_fwvga_ips

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=ili9806e_dsi_vdo_dijin_fwvga_d507 otm8018b_dsi_vdo_trust_fwvga_ips ili9806e_dsi_vdo_azet_fwvga_ips ili9806e_dsi_vdo_hlt_fwvga_ips
...
MTK_PRODUCT_LOCALES=en_US zh_TW uk_UA ru_RU pl_PL cs_CZ tr_TR hu_HU ro_RO bg_BG it_IT es_ES fr_FR pt_PT sl_SI sk_SK lt_LT hr_HR ar_EG iw_IL zh_CN lv_LV el_GR fa_IR sr_RS hi_IN in_ID th_TH tl_PH vi_VN hdpi
...
MTK_PROJECT_CUSTOMER = PROJECT_CUSTOMER_D620
...
#add for TP upgrade  node self apk support 20130717 by xiaoanxiang(start)
#M:zhaoguangyou Bug_ID:DWLQ-332{
#RGK_TP_NODE_UPGRAER_SELF_APK_SUPPORT = no
...
#add for default mobile data enabled zhangzixiao DELB-1185 20130802 (start)
#RGK_DEFAULT_MOBILE_DATA_ENABLED = yes
#add DELB-1511 liangylong
RGK_DEFAULT_MOBILE_DATA_ENABLED = yes
#add for default mobile data enabled zhangzixiao DELB-1185 20130802 (end)
# add shengui.zhu DELB-1259 20130805 (start)
#Modify the function in kernel by baojun.jia,so just close this feature in Java code.
RGK_HOOK_DOUBLE_CLICK_EVENT_ENABLED = no
# add shengui.zhu DELB-1259 20130805 (end)
#add for MAXIMUS huruilong 20130625 (start)
RGK_D208_GIGABYTE_SUPPORT = yes
#add for MAXIMUS huruilong 20130625 (end)
#Delete the IP_CALL DELB-1366 maoxinwei 20130819 start; DELB-2056 maoxinwei 20130909 start
#RGK_IP_DIAL = no
#Delete the IP_CALL DELB-1366 maoxinwei 20130819 end; DELB-2056 maoxinwei 20130909 end
...
# add lixiaobin BUG_ID:DELB-1843 start
RGK_LONGCLICK_HEADSETHOOK = yes
# add lixiaobin BUG_ID:DELB-1843 end
# add huangyouzhong BUG_ID:DELB-1966 start
RGK_LAUNCHER_DELECT_POSITION_SUPPORT = yes
# add huangyouzhong BUG_ID:DELB-1966 end
#add for turn off MTK_THEMAL_HW_PROTECT  add by huruilong,if provider sw to giga test, no --> yes
RGK_TURNOFF_HW_THEMAL_PROTECT = no
RGK_GIGABYTE_IOUI_SUPPORT = yes
# add liubin BUG_ID:DWLQ-520 2014.0106(start)
RGK_STATUSBAR_TRANSPARENT = yes
# add liubin BUG_ID:DWLQ-520 2014.0106(end)

#add BUG_ID:DWLQ-852 chenweihua 20140114 (start) 
RGK_LANGUAGE_SET_BY_SIM_SUPPORT = yes
#add BUG_ID:DWLQ-852 chenweihua 20140114 (end)
