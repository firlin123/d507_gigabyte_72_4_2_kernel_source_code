...
s32 gtp_init_panel_for_shorttest(struct i2c_client *client)
{
  ...
  // restore code befor while add another func gtp_i2c_test_for_power_on(xx) ,by RGK anxiang.xiao 20142014-02-13
static s8 gtp_i2c_test(struct i2c_client *client)
{
   ...
   // change for decrease tp check so to cause system reboot in eng  5 --> 1, anxiang.xiao 2014-01-18,1-->3 ,for tp resume too late anxiang.xiao 2014-0126
   while (retry++ < 5)
    {
        ...
        // change for decrease tp check so to cause system reboot in eng  10 --> 5, anxiang.xiao 2014-01-18,5-->10 anxiang.xiao 2014-0126,for tp resume too late anxiang.xiao 2014-0126
         msleep(10);
    }
...
// defined for test power on use as less retry time not to casuse system reboot ,add by RGK anxiang.xiao  2014-02-13
static s8 gtp_i2c_test_for_power_on(struct i2c_client *client)
{
...
reset_proc:
  ...
  // decreae delay as to incase of whatchdog reboot during booting , by anxiang.xiao 2014-01-20
   //  gtp_reset_guitar(client, 20);
...
#endif
    {
    	// dependtly use test func as not to cause old test func , RGK anxiang.xiao 2014-02-13
	#if 0
	ret = gtp_i2c_test(client);
	#else
	  ret = gtp_i2c_test_for_power_on(client);
	#endif
...
static int tpd_local_init(void)
{
 ...
 #if 0 // disable for unchecked tp del ,maybe work unnormal by anxiang.xiao 2014-0120
...
static int __init tpd_driver_init(void)
{
	...
	// disable tp test func , by anxiang.xiao 2014-01-20
     	// gtp_test_sysfs_init();
