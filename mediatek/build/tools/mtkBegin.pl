...
# Add by renqingyou for hami 3rd application start
&p_system("mkdir -p ${projectout}/system/vendor/hami/app");
&p_system("cp -r vendor/ragentek/${prj}/pre-hami-apk/*.apk ${projectout}/system/vendor/hami/app");
# Add by renqingyou for hami 3rd application end
