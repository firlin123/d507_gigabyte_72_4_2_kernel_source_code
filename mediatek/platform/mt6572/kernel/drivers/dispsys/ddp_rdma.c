...
#if 1//lisong 2014-4-11 [NO BUGID][72M support wvga]start
extern u32 get_devinfo_with_index(u32 index);
#endif//lisong 2014-4-11 [NO BUGID][72M support wvga]end
                    ...
                    bool isRGBSwap)  // ourput setting
{
    unsigned bpp;
		...
		cpu_type = get_devinfo_with_index(18);
		cpu_type = (cpu_type >> 8) & 0x00000003;
#endif//lisong 2014-4-11 [NO BUGID][72M support wvga]end      
    ...
    DISP_REG_SET_FIELD(MEM_CON_FLD_MEM_MODE_INPUT_FORMAT, idx * DISP_INDEX_OFFSET + DISP_REG_RDMA_MEM_CON, inputFormat);
		...
		if(cpu_type == 3)
		{
	    DISP_REG_SET_FIELD(MEM_CON_FLD_MEM_MODE_TILE_EN, idx * DISP_INDEX_OFFSET + DISP_REG_RDMA_MEM_CON, 0x1);
	    DISP_REG_SET_FIELD(MEM_CON_FLD_MEM_MODE_TILE_INTER_EN, idx * DISP_INDEX_OFFSET + DISP_REG_RDMA_MEM_CON, 0x1);
  	}
#endif//lisong 2014-4-11 [NO BUGID][72M support wvga]end 
...
#if 1//lisong 2014-4-11 [NO BUGID][72M support wvga]start
		if(cpu_type == 3)
    	DISP_REG_SET_FIELD(SIZE_CON_1_FLD_OUTPUT_FRAME_HEIGHT, idx * DISP_INDEX_OFFSET + DISP_REG_RDMA_SIZE_CON_1, height/2*3);
    else
