...
const HI704_SENSOR_INIT_INFO HI704_Initial_Setting_Info[] =
{
   ...
   {0x03, 0x00},   //PAGEMODE(0x03)
	...
	//PAGE 10
	{0x03, 0x10},
	{0x10, 0x00}, //03, //ISPCTL1, YUV ORDER(FIX)
	{0x11, 0x43},
	...
	{0x60, 0x8d},
	{0x61, 0x10}, //
	{0x62, 0x75}, //SATB //a0//80/b5//60//62
	{0x63, 0x8E}, //SATR //70//93//c0//78//70
	{0x64, 0x68}, //AGSAT//48//48
	{0x66, 0x90},
	{0x67, 0x67}, //wht_gain//34
...
{0x8E, 0xbc}, 
	...
	{0x9c, 0x06}, //EXP Limit 250.00 fps 
	{0x9d, 0xd6}, 
	{0x9e, 0x00}, //EXP Unit 
	{0x9f, 0xfa}, 
...
void HI704_night_mode(kal_bool enable)
{
    ...
    HI704_write_cmos_sensor(0x41, 0x15);   
	HI704_write_cmos_sensor(0x03, 0x20);
    HI704_write_cmos_sensor(0xB2, 0xC0);   
    }
    else
    {
         ...
         HI704_write_cmos_sensor(0x03, 0x10);
    HI704_write_cmos_sensor(0x41, 0x00);   
	HI704_write_cmos_sensor(0x03, 0x20);
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_CLOUDY_DAYLIGHT:
    {
        ...
        HI704_write_cmos_sensor(0x80, 0x42);
        HI704_write_cmos_sensor(0x82, 0x19);
        HI704_write_cmos_sensor(0x83, 0x43);
        HI704_write_cmos_sensor(0x84, 0x41);
        HI704_write_cmos_sensor(0x85, 0x1a);
        HI704_write_cmos_sensor(0x86, 0x18);
        HI704_write_cmos_sensor(0x10, 0xfb);
        }			   
        break;
    case AWB_MODE_DAYLIGHT:
        ...
        HI704_write_cmos_sensor(0x03, 0x22);
        HI704_write_cmos_sensor(0x11, 0x28);          
        HI704_write_cmos_sensor(0x80, 0x76);
        HI704_write_cmos_sensor(0x82, 0x1c);
        HI704_write_cmos_sensor(0x83, 0x77);
        HI704_write_cmos_sensor(0x84, 0x75);
        HI704_write_cmos_sensor(0x85, 0x1d);
        HI704_write_cmos_sensor(0x86, 0x1b);
        HI704_write_cmos_sensor(0x10, 0xfb);
        }      
        break;
    ...
    case AWB_MODE_FLUORESCENT:
        ...
        HI704_write_cmos_sensor(0x03, 0x22);
        HI704_write_cmos_sensor(0x11, 0x28);
        HI704_write_cmos_sensor(0x80, 0x55);
        HI704_write_cmos_sensor(0x82, 0x0d);
        HI704_write_cmos_sensor(0x83, 0x0c);
        HI704_write_cmos_sensor(0x84, 0x0a);
        HI704_write_cmos_sensor(0x85, 0x58);
        HI704_write_cmos_sensor(0x86, 0x54);
        HI704_write_cmos_sensor(0x10, 0xfb);
        }	
        break;  
    case AWB_MODE_TUNGSTEN:
        {
        HI704_write_cmos_sensor(0x03, 0x22);
        HI704_write_cmos_sensor(0x80, 0x20);
       // HI704_write_cmos_sensor(0x81, 0x20);
        HI704_write_cmos_sensor(0x82, 0x6a);
        HI704_write_cmos_sensor(0x83, 0x21);
        HI704_write_cmos_sensor(0x84, 0x1f);
        HI704_write_cmos_sensor(0x85, 0x6c);
        HI704_write_cmos_sensor(0x86, 0x69);
        HI704_write_cmos_sensor(0x10, 0xfb);
        }
        break;
    case AWB_MODE_OFF:
