...
#define LIHE_SENSOR_ID_NEW_ITO 			2
...
// for TP info
	...
	else if (sensor_id_g == LIHE_SENSOR_ID_NEW_ITO) 
		len = sprintf(tp_info, "TP IC :%s,TP module :%s,TP I2C adr : 0x%x,","gt9xx","LiHe_new_ITO",client->addr);
	else
