...
void SP2518_night_mode(kal_bool bEnable)
{
	...
	//capture preview daylight 48M 60Hz fix 9FPS maxgain   
		...
		else/*capture normal mode*/
		{
		  ...
		  SP2518_write_cmos_sensor(0x04,0x70);
		  SP2518_write_cmos_sensor(0x09,0x00);
		  SP2518_write_cmos_sensor(0x0a,0xe4); 
		  SP2518_write_cmos_sensor(0xf0,0x68);
		  SP2518_write_cmos_sensor(0xf1,0x00);
		  SP2518_write_cmos_sensor(0xfd,0x01);	  
		  SP2518_write_cmos_sensor(0x90,0x0c);	  
		  SP2518_write_cmos_sensor(0x92,0x01);
		  SP2518_write_cmos_sensor(0x98,0x68);
		  SP2518_write_cmos_sensor(0x99,0x00);
		  SP2518_write_cmos_sensor(0x9a,0x01);
		  SP2518_write_cmos_sensor(0x9b,0x00);
		...
		//capture preview daylight 48M 50hz fix 9FPS maxgain   
		  ...
		  SP2518_write_cmos_sensor(0xfd,0x00);	  
			...
			else/*video normal mode 60hz*/
			{
				...
				SP2518_write_cmos_sensor(0xfd,0x00);
				SP2518_write_cmos_sensor(0x03,0x02);
				SP2518_write_cmos_sensor(0x04,0x0a); 
				SP2518_write_cmos_sensor(0x09,0x00);
				SP2518_write_cmos_sensor(0x0a,0xdf); 
				SP2518_write_cmos_sensor(0xf0,0x57);
				SP2518_write_cmos_sensor(0xf1,0x00);
				SP2518_write_cmos_sensor(0xfd,0x01);	 
				SP2518_write_cmos_sensor(0x90,0x0f);	 
				SP2518_write_cmos_sensor(0x92,0x01);
				SP2518_write_cmos_sensor(0x98,0x57);
				SP2518_write_cmos_sensor(0x99,0x00);
				SP2518_write_cmos_sensor(0x9a,0x01);
				SP2518_write_cmos_sensor(0x9b,0x00);
				SP2518_write_cmos_sensor(0xfd,0x01);
				SP2518_write_cmos_sensor(0xce,0x19);
				SP2518_write_cmos_sensor(0xcf,0x05);
				SP2518_write_cmos_sensor(0xd0,0x19);
				SP2518_write_cmos_sensor(0xd1,0x05);
				SP2518_write_cmos_sensor(0xd7,0x53);//exp_nr_outd_8lsb
				SP2518_write_cmos_sensor(0xd8,0x00);
				SP2518_write_cmos_sensor(0xd9,0x57);//exp_outd_nr_8lsb
				SP2518_write_cmos_sensor(0xda,0x00);
				SP2518_write_cmos_sensor(0xfd,0x00);
			#else
//capture preview daylight 48M 60Hz fix 9FPS maxgain   
	...
	switch (para)
	 {
	   ...
	   case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			 ...
			 SP2518_write_cmos_sensor(0x32,0x05);
			 SP2518_write_cmos_sensor(0xfd,0x01);
			 SP2518_write_cmos_sensor(0x28,0xff);
			 SP2518_write_cmos_sensor(0x29,0x9c);
			 SP2518_write_cmos_sensor(0xfd,0x00);
		 break;
	   case AWB_MODE_DAYLIGHT: //sunny
			 ...
			 SP2518_write_cmos_sensor(0x32,0x05);
			 SP2518_write_cmos_sensor(0xfd,0x01);
			 SP2518_write_cmos_sensor(0x28,0xed);
			 SP2518_write_cmos_sensor(0x29,0x7d);
			 SP2518_write_cmos_sensor(0xfd,0x00);
		 break;
	   ...
	   case AWB_MODE_TUNGSTEN: //home
			 ...
			 SP2518_write_cmos_sensor(0x32,0x05);
			 SP2518_write_cmos_sensor(0xfd,0x01);
			 SP2518_write_cmos_sensor(0x28,0x9d);
			 SP2518_write_cmos_sensor(0x29,0xbe);
			 SP2518_write_cmos_sensor(0xfd,0x00);
		 break;
	   case AWB_MODE_FLUORESCENT:
			 ...
			 SP2518_write_cmos_sensor(0x29,0xd4);
			 SP2518_write_cmos_sensor(0xfd,0x00);
			 break;
	   default:
		 return FALSE;
	 ...
	 switch (para)
	  {
	    ...
	    case MEFFECT_SEPIABLUE:
			SP2518_write_cmos_sensor(0xfd, 0x00);
			SP2518_write_cmos_sensor(0x62, 0x10);
			SP2518_write_cmos_sensor(0x63, 0x40);
			SP2518_write_cmos_sensor(0x64, 0xd8);
	      break;
...
#define FLASH_BV_THRESHOLD 0x70
static void SP2518_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int NormBr;
    SP2518_SET_PAGE0;
    NormBr = SP2518_read_cmos_sensor(0xf2);
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
             SP2518_FlashTriggerCheck(pFeatureData32);
             SENSORDB("[SP2518] F_GET_TRIGGER_FLASHLIGHT_INFO: %d\n", pFeatureData32);
             break;		
    default:
        break;
	}
