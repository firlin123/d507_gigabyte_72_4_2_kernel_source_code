...
//#define DEBUG_SENSOR_SP0A19
 ...
 u32 SP0A19_strtol(const char *nptr, u8 base)
{
	u8 ret;
	   ...
	   if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
		{
				...
				//Video record night 24M 50hz 12-12FPS maxgain:0x8c
					...
					SP0A19_write_cmos_sensor(0x32, (temp_AE_reg |0x05));
	...
	else    // daylight mode
	{
		...
		else 
			{
			   //	SENSORDB(" SP0A19_banding=%x\r\n",SP0A19_banding);
				...
				{
				#if 1 //lj_test
						//ae setting 50HZ 24M 6fps
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
					SP0A19_write_cmos_sensor(0x04,0x8a);
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x06);
					SP0A19_write_cmos_sensor(0x0a,0xdf);
					SP0A19_write_cmos_sensor(0xf0,0x2e);
					SP0A19_write_cmos_sensor(0xf1,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0x90,0x10);
					SP0A19_write_cmos_sensor(0x92,0x01);
					SP0A19_write_cmos_sensor(0x98,0x2e);
					SP0A19_write_cmos_sensor(0x99,0x00);
					SP0A19_write_cmos_sensor(0x9a,0x01);
					SP0A19_write_cmos_sensor(0x9b,0x00);
				...
				#else
					//capture preview daylight 24M 50hz 11-8FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
					...
					SP0A19_write_cmos_sensor(0x9b,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0xce,0xac);
					SP0A19_write_cmos_sensor(0xcf,0x02);
					SP0A19_write_cmos_sensor(0xd0,0xac);
					SP0A19_write_cmos_sensor(0xd1,0x02);
					SP0A19_write_cmos_sensor(0xfd,0x00);	
					temp_AE_reg = SP0A19_read_cmos_sensor(0x32);
					SP0A19_write_cmos_sensor(0x32, (temp_AE_reg |0x05));
				...
				{
				#if 1 //lj_test
					//capture preview daylight 24M 60hz 6-9FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
					SP0A19_write_cmos_sensor(0x04,0x75);
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x06);
					SP0A19_write_cmos_sensor(0x0a,0xb2);
					SP0A19_write_cmos_sensor(0xf0,0x27);
					SP0A19_write_cmos_sensor(0xf1,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0x90,0x14);
					SP0A19_write_cmos_sensor(0x92,0x01);
					SP0A19_write_cmos_sensor(0x98,0x27);
					SP0A19_write_cmos_sensor(0x99,0x00);
					SP0A19_write_cmos_sensor(0x9a,0x01);
					SP0A19_write_cmos_sensor(0x9b,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					...
					SP0A19_write_cmos_sensor(0x32, (temp_AE_reg |0x05));
				#else
					//capture preview daylight 24M 60hz 11-8FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x00);
					...
					SP0A19_write_cmos_sensor(0x9b,0x00);
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0xce,0xd0);
					SP0A19_write_cmos_sensor(0xcf,0x02);
					SP0A19_write_cmos_sensor(0xd0,0xd0);
					SP0A19_write_cmos_sensor(0xd1,0x02);
					SP0A19_write_cmos_sensor(0xfd,0x00);	
					temp_AE_reg = SP0A19_read_cmos_sensor(0x32);
					SP0A19_write_cmos_sensor(0x32, (temp_AE_reg |0x05));
...
#endif
{
	...
	SP0A19_write_cmos_sensor(0x31,0x00);//0x10
	#endif
	SP0A19_write_cmos_sensor(0xfb,0x31); // 0x30
	SP0A19_write_cmos_sensor(0x1f,0x10);

	SP0A19_write_cmos_sensor(0xfd,0x00); // 0x30
	SP0A19_write_cmos_sensor(0xf4,0x08);
	//Blacklevel
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x65,0x00);//blue_suboffset 0x06
	SP0A19_write_cmos_sensor(0x66,0x00);//red_suboffset  0x06
	SP0A19_write_cmos_sensor(0x67,0x00);//gr_suboffset   0x06
	SP0A19_write_cmos_sensor(0x68,0x00);//gb_suboffset   0x06
	SP0A19_write_cmos_sensor(0x45,0x00);
	SP0A19_write_cmos_sensor(0x46,0x0f);

	#if 1 //lj_test
	//ae setting 50HZ 24M 6-9fps
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x03,0x00);
	SP0A19_write_cmos_sensor(0x04,0x8a);
	SP0A19_write_cmos_sensor(0x06,0x00);
	...
	SP0A19_write_cmos_sensor(0x58,0x0f); //raw_dif_thr_normal
	SP0A19_write_cmos_sensor(0x56,0x14); //raw_dif_thr_dummy
	SP0A19_write_cmos_sensor(0x59,0x14); //raw_dif_thr_lowlight
	//GrGb
	SP0A19_write_cmos_sensor(0x89,0x06); //raw_grgb_thr_outdoor 
	SP0A19_write_cmos_sensor(0x8a,0x0f); //raw_grgb_thr_normal	
	SP0A19_write_cmos_sensor(0x9c,0x14); //raw_grgb_thr_dummy	
	SP0A19_write_cmos_sensor(0x9d,0x14); //raw_grgb_thr_lowlight
	//Gr\Gb
	SP0A19_write_cmos_sensor(0x81,0xe0); //raw_gflt_fac_outdoor
	SP0A19_write_cmos_sensor(0x82,0xd0); //raw_gflt_fac_normal
	SP0A19_write_cmos_sensor(0x83,0x70); //raw_gflt_fac_dummy
	SP0A19_write_cmos_sensor(0x84,0x30); //raw_gflt_fac_lowlight
	//GrGb
	SP0A19_write_cmos_sensor(0x85,0xe0); //raw_gf_fac_outdoor  
	SP0A19_write_cmos_sensor(0x86,0xd0); //raw_gf_fac_normal  
	SP0A19_write_cmos_sensor(0x87,0x70); //raw_gf_fac_dummy   
	SP0A19_write_cmos_sensor(0x88,0x30); //raw_gf_fac_lowlight
	//
	SP0A19_write_cmos_sensor(0x5a,0xff);  //raw_rb_fac_outdoor
	SP0A19_write_cmos_sensor(0x5b,0xd0);  //raw_rb_fac_normal
	SP0A19_write_cmos_sensor(0x5c,0x70);  //raw_rb_fac_dummy
	SP0A19_write_cmos_sensor(0x5d,0x30);  //raw_rb_fac_lowlight
#else
	//smooth
	SP0A19_write_cmos_sensor(0xfd,0x00);
	//
	...
	SP0A19_write_cmos_sensor(0xe5,0x08); //rangek_neg_outdoor  //0x08
	SP0A19_write_cmos_sensor(0xd3,0x08); //rangek_pos_outdoor	//0x08
	SP0A19_write_cmos_sensor(0xd7,0x08); //range_base_outdoor	//0x08

	SP0A19_write_cmos_sensor(0xe6,0x0a); //rangek_neg_normal   // 0x08
	SP0A19_write_cmos_sensor(0xd4,0x0a); //rangek_pos_normal   // 0x08
	SP0A19_write_cmos_sensor(0xd8,0x0a); //range_base_normal   // 0x08

	SP0A19_write_cmos_sensor(0xe7,0x15); //rangek_neg_dummy   // 0x10
	SP0A19_write_cmos_sensor(0xd5,0x15); //rangek_pos_dummy   // 0x10
	SP0A19_write_cmos_sensor(0xd9,0x15); //range_base_dummy    // 0x10
	...
	//ae min gain  
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x94,0x80);  //rpc_max_indr 0x88
	...
	//ae target
	SP0A19_write_cmos_sensor(0xfd,0x00); 
	SP0A19_write_cmos_sensor(0xed,0x94); //80  0x8c 0x9c
	SP0A19_write_cmos_sensor(0xf7,0x90); //7c  0x88 0x98
	SP0A19_write_cmos_sensor(0xf8,0x88); //70  0x80 0x90
	SP0A19_write_cmos_sensor(0xec,0x94); //6c  0x8c 0x9c

	SP0A19_write_cmos_sensor(0xef,0x7c); //99 0x74 0x84
	SP0A19_write_cmos_sensor(0xf9,0x78); //90 0x70 0x80
	SP0A19_write_cmos_sensor(0xfa,0x70); //80 0x68 0x78
	SP0A19_write_cmos_sensor(0xee,0x6c); //78 0x64 0x74
...
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0xfd,0x01);
SP0A19_write_cmos_sensor(0x35,0x33);
SP0A19_write_cmos_sensor(0x36,0x2D);
SP0A19_write_cmos_sensor(0x37,0x27);
SP0A19_write_cmos_sensor(0x38,0x3D);
SP0A19_write_cmos_sensor(0x39,0x29);
SP0A19_write_cmos_sensor(0x3a,0x1F);
SP0A19_write_cmos_sensor(0x3b,0x1b);
SP0A19_write_cmos_sensor(0x3c,0x2A);
SP0A19_write_cmos_sensor(0x3d,0x29);
SP0A19_write_cmos_sensor(0x3e,0x22);
SP0A19_write_cmos_sensor(0x3f,0x1f);
SP0A19_write_cmos_sensor(0x40,0x3B);
SP0A19_write_cmos_sensor(0x41,0x10);
SP0A19_write_cmos_sensor(0x42,0x1e);
SP0A19_write_cmos_sensor(0x43,0x0a);
SP0A19_write_cmos_sensor(0x44,0x0e);
SP0A19_write_cmos_sensor(0x45,0x0e);
SP0A19_write_cmos_sensor(0x46,0x14);
SP0A19_write_cmos_sensor(0x47,0x06);
SP0A19_write_cmos_sensor(0x48,0x0e);
SP0A19_write_cmos_sensor(0x49,0x0f);
SP0A19_write_cmos_sensor(0x4a,0x11);
SP0A19_write_cmos_sensor(0x4b,0x06);
SP0A19_write_cmos_sensor(0x4c,0x06);
SP0A19_write_cmos_sensor(0xfd,0x00);
SP0A19_write_cmos_sensor(0xfd,0x01);
SP0A19_write_cmos_sensor(0x28,0xc5);
SP0A19_write_cmos_sensor(0x29,0x9b);
...
SP0A19_write_cmos_sensor(0x58,0x0f);
SP0A19_write_cmos_sensor(0x56,0x14);
SP0A19_write_cmos_sensor(0x59,0x14);
SP0A19_write_cmos_sensor(0x89,0x06);
SP0A19_write_cmos_sensor(0x8a,0x0f);
SP0A19_write_cmos_sensor(0x9c,0x14);
SP0A19_write_cmos_sensor(0x9d,0x14);
SP0A19_write_cmos_sensor(0x81,0xe0);
SP0A19_write_cmos_sensor(0x82,0xd0);
SP0A19_write_cmos_sensor(0x83,0x70);
SP0A19_write_cmos_sensor(0x84,0x30);
SP0A19_write_cmos_sensor(0x85,0xe0);
SP0A19_write_cmos_sensor(0x86,0xd0);
SP0A19_write_cmos_sensor(0x87,0x70);
SP0A19_write_cmos_sensor(0x88,0x30);
SP0A19_write_cmos_sensor(0x5a,0xff);
SP0A19_write_cmos_sensor(0x5b,0xd0);
SP0A19_write_cmos_sensor(0x5c,0x70);
SP0A19_write_cmos_sensor(0x5d,0x30);
SP0A19_write_cmos_sensor(0xfd,0x01);
...
SP0A19_write_cmos_sensor(0xfd,0x01);
SP0A19_write_cmos_sensor(0x94,0x80);
...
SP0A19_write_cmos_sensor(0xec,0x94);
...
SP0A19_write_cmos_sensor(0xc0,0xff);
SP0A19_write_cmos_sensor(0xc1,0xd8);
SP0A19_write_cmos_sensor(0xd3,0x78);
SP0A19_write_cmos_sensor(0xd4,0x78);
...
SP0A19_write_cmos_sensor(0x5f,0x51);
SP0A19_write_cmos_sensor(0xf4,0x08);
SP0A19_write_cmos_sensor(0xff,0xff);
	#endif
}
}
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	SENSORDB("sym SP0A19Control:ScenarioId =%d \n",SP0A19CurrentScenarioId);
...
SENSORDB("%s\n",__func__);
	...
	{            
		case AWB_MODE_AUTO:
			...
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xc5);//c4 fs		                                                       
			SP0A19_write_cmos_sensor(0x29,0x9b);//9e fs
			SP0A19_write_cmos_sensor(0xfd,0x00);  // AUTO 3000K~7000K   	  
			SP0A19_write_cmos_sensor(0x32,0x15); //awb2    				
		    break;
		case AWB_MODE_OFF:
	         {
			 SP0A19_write_cmos_sensor(0xfd,0x01);														   
		...
		case AWB_MODE_CLOUDY_DAYLIGHT:
			...
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xe8);		                                                       
			SP0A19_write_cmos_sensor(0x29,0x78);		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00);   
		    break;
		case AWB_MODE_DAYLIGHT:
			...
			SP0A19_write_cmos_sensor(0x29,0x7c);		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;
		...
		case AWB_MODE_FLUORESCENT:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0x50);		                                                       
			SP0A19_write_cmos_sensor(0x29,0xcc);		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;  
		case AWB_MODE_TUNGSTEN:
			...
			SP0A19_write_cmos_sensor(0x29,0xc0);		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00);  
		    break;
		default:
			return KAL_FALSE;
...
BOOL SP0A19_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_SEPIABLUE:
		  	SP0A19_write_cmos_sensor(0xfd, 0x00);
			SP0A19_write_cmos_sensor(0x62, 0x10);
			SP0A19_write_cmos_sensor(0x63, 0x40);
			SP0A19_write_cmos_sensor(0x64, 0xd8);
			break;        
		case MEFFECT_MONO:			
			SP0A19_write_cmos_sensor(0xfd, 0x00);
...
SENSORDB("%s\n",__func__);
    switch (para)
    {
			SP0A19_write_cmos_sensor(0xfd, 0x00);
        case ISP_SAT_HIGH:
			SP0A19_write_cmos_sensor(0xd3,0x78+0x20); //outdoor 
			SP0A19_write_cmos_sensor(0xd4,0x78+0x20); //normal 
			SP0A19_write_cmos_sensor(0xd6,0x70+0x20); //dummy
			SP0A19_write_cmos_sensor(0xd7,0x60+0x20); //low light
			break;  
        case ISP_SAT_LOW:
			SP0A19_write_cmos_sensor(0xd3,0x78-0x20); 
			SP0A19_write_cmos_sensor(0xd4,0x78-0x20); 
			SP0A19_write_cmos_sensor(0xd6,0x70-0x20); 
			SP0A19_write_cmos_sensor(0xd7,0x60-0x20);
			break;    
        case ISP_SAT_MIDDLE:
        default:
			SP0A19_write_cmos_sensor(0xd3,0x78);//88 fs
			SP0A19_write_cmos_sensor(0xd4,0x78);//88 fs 
			SP0A19_write_cmos_sensor(0xd6,0x70); 
			SP0A19_write_cmos_sensor(0xd7,0x60);
			break;    
    }
